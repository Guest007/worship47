...
class Song(models.Model):
    ...
    main_key = models.CharField(max_length=2, choices=CHORDS, default="E", blank=True)
    difficult = models.CharField(max_length=6, choices=DIFFICULT, default="easy", blank=True)
